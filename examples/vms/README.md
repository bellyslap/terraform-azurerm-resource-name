# Example: Virtual Machine (Multiple Instances)

This example uses the module to generate the names for two (2) **_example_** virtual machines deployed to the **_eastus2_** region for the **_dev_** environment.
